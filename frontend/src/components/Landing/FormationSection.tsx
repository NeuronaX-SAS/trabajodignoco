  ...
  return (
    <section id="education" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-64 h-64 bg-[#BFAF8F]/20 rounded-full filter blur-2xl opacity-20 -ml-32 -mt-32"></div>
        <div className="absolute bottom-0 right-0 w-64 h-64 bg-[#733A19]/20 rounded-full filter blur-2xl opacity-20 -mr-32 -mb-32"></div>
      </div>

  ...
  return (
    <section id="resources" className="py-20 bg-[#F2F0F0] relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#153959] rounded-full filter blur-2xl opacity-10 -mr-32 -mt-32"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#733A19] rounded-full filter blur-2xl opacity-10 -ml-32 -mb-32"></div>
      </div>

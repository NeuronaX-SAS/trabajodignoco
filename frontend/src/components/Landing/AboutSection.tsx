          ...
          >
            ...
            <div className="pt-4">
              <button 
                ...
                className="bg-[#733A19] hover:bg-[#5C2E14] text-white font-semibold py-3 px-8 rounded-md shadow transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg mr-4"
              >
                Explorar Recursos
              </button>
              <button 
                ...
                className="bg-transparent hover:bg-[#BFAF8F]/20 text-[#733A19] border border-[#733A19] font-semibold py-3 px-8 rounded-md transition duration-300 ease-in-out"
              >
                Únete a Nosotros
              </button>
            </div>

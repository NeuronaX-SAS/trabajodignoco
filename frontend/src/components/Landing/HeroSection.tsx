          ...
          >
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 mb-8">
              <motion.button
                ...
                className="bg-[#BFAF8F] text-[#0E1013] hover:bg-[#D0C7AF] font-semibold py-3 px-8 rounded-md shadow-lg transition duration-300 ease-in-out w-full sm:w-auto"
            ...
            <div className="flex flex-wrap justify-center sm:justify-start items-center space-x-6 text-[#F2F0F0]">
              <a href="https://www.facebook.com/profile.php?id=61575746772724" target="_blank" rel="noopener noreferrer" className="hover:text-[#BFAF8F] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M9.198 21.5h4v-8.01h3.604l.396-3.98h-4V7.5a1 1 0 0 1 1-1h3v-4h-3a5 5 0 0 0-5 5v2.01h-2l-.396 3.98h2.396v8.01z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/trabajodigno.col/" target="_blank" rel="noopener noreferrer" className="hover:text-[#BFAF8F] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.tiktok.com/@trabajodigno.col" target="_blank" rel="noopener noreferrer" className="hover:text-[#BFAF8F] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
